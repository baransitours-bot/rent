        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-lg font-bold text-gray-900">{locale === "ar" ? brand.name : brand.nameEn}</span>
            </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            {isLoggedIn ? (
              <Link
                href="/dashboard"
                className="px-4 py-2 text-white text-sm font-semibold transition-colors flex items-center gap-2"
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-stone-100">
                          <span className="text-xs font-medium" style={{ color: brand.color }}>{prop.user.companyName || prop.user.name}</span>
            ...
            {agents.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                {agents.map((agent) => (
                  ...
                  >
                    <div className="w-14 h-14 flex items-center justify-center mb-4" style={{ backgroundColor: brand.color }}>
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-stone-200">
                      ...
                      <span className="text-xs font-semibold flex items-center gap-1" style={{ color: brand.color }}>
