      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-xl border p-4 mb-6 space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button onClick={() => setTypeFilter("")} className={clsx("px-3 py-1.5 rounded-lg text-xs font-medium border transition-colors", !typeFilter ? "bg-blue-50 border-blue-300 text-blue-700" : "bg-white border-gray-200 text-gray-600 hover:bg-gray-50")}>
              {txt[locale].allTypes}
            </button>
            {["apartment", "house", "shop", "land", "other"].map((tp) => (
              <button key={tp} onClick={() => setTypeFilter(tp)} className={clsx("px-3 py-1.5 rounded-lg text-xs font-medium border transition-colors", typeFilter === tp ? "bg-blue-50 border-blue-300 text-blue-700" : "bg-white border-gray-200 text-gray-600 hover:bg-gray-50")}>
